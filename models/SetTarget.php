...
class SetTarget extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'income', 'family_member', 'children_no', 'house_type', 'monthly_rent', 'investment_habit', 'suggest_target', 'working_member', 'created_date', 'modify_date'], 'required'],
            [['user_id', 'family_member', 'children_no', 'house_type', 'investment_habit', 'working_member', 'status'], 'integer'],
