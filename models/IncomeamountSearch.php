...
/**
 * IncomeamountSearch represents the model behind the search form about `app\models\IncomeAmount`.
 */
class IncomeamountSearch extends IncomeAmount
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'user_id', 'income_category_id', 'repeat'], 'integer'],
