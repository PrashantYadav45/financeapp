...
class ExpenseAmount extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'selectdate', 'expense_category_id', 'payment_detail', 'amount', 'account', 'note', 'bill_image', 'repeat','repitition_period','status', 'created_date', 'modify_date'], 'required'],
